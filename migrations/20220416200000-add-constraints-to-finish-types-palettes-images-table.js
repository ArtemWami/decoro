const tableName = 'finish_types_palettes_images';
    ...
    try {
        await Promise.all([
            queryInterface.addConstraint(tableName, {
                transaction,
                fields: ['finish_type_id'],
                type: 'foreign key',
                name: `fkey_${tableName}_finish_type_id`,
                onDelete: 'cascade',
                onUpdate: 'cascade',
                references: {
                    table: 'finish_types',
            ...
            queryInterface.addConstraint(tableName, {
                ...
                fields: ['palette_id'],
                type: 'foreign key',
                name: `fkey_${tableName}_palette_id`,
                onDelete: 'cascade',
                onUpdate: 'cascade',
                references: {
                    table: 'palettes',
...
const down = async (queryInterface) => {
    ...
    try {
        await Promise.all([
            queryInterface.removeConstraint(tableName, `fkey_${tableName}_finish_type_id`, {
                transaction,
            }),
            queryInterface.removeConstraint(tableName, `fkey_${tableName}_palette_id`, {
                transaction,
            }),
