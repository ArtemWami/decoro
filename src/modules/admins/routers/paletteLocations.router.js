...
const paletteLocationImagesController = require('../controllers/paletteLocationImages.controller');
const { getRequestParam } = require('../../../helpers/middleware');
const { checkPaletteLocationPermission } = require('../../../middlewares/companyPermissions');
